...
datapath = '/data/lisatmp4/faruk/pixelvae/mnist_pixvae_pca/'
plotpath = '/data/lisatmp4/faruk/pixelvae/pca_plot_pixvae/'
...
for name in names:
    ...
    if iter_ == 151500: # this is where we had lowest validation error
